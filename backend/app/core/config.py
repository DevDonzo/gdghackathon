...
class Settings(BaseSettings):
    ...
    agent_mode: str = Field(default="adk", alias="RATEDROP_AGENT_MODE")
    agent_model_provider: str = Field(default="gemini", alias="RATEDROP_AGENT_MODEL_PROVIDER")
    ...
    def normalized_agent_mode(self) -> str:
        ...
        return mode if mode in {"adk", "disabled"} else "disabled"
